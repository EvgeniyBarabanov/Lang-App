...
function AudioCallGame() {
    ...
    function handleSubmit(route) {
        navigate(route, {
            replace: true,
            state: { correctlyAnswers, mistakes, lives, maxWordsValue },
        });
    }
    ...
    return (
        <div
            ...
            <div
                ...
                <div
                    ref={heart}
                    className="audio-call-game__hearts">
                ...
                <p className="text text_size12">
                    *You can also use the 1-5 keys on the keyboard
                </p>
            </div>
        </div>
    );
